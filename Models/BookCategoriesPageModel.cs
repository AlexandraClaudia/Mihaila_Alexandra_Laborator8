...
namespace Mihaila_Alexandra_Laborator8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Mihaila_Alexandra_Laborator8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Mihaila_Alexandra_Laborator8Context context, string[] selectedCategories, Book bookToUpdate)
        {
